...
What is an integer data type? An integer data type is a data type that contains a number in it, such as 5.
What is a string data type? A string data type is a sata type that contains some text inside a quote. 
What is a boolean data type? A boolean data type is a data type that contains the conditions "True" or "False".
*/
...
/*QUESTION 4: 4 Points */
/* Below, you will see a variable called number2 that is equal to 1. Using a while loop, i want you create a
...
Well, the HTML dom is important because it not only allows access to the CSS of a webpage, it also allows us to modify HTML elements.
/*

/*Question 8: 4 points*/
/*Explain what the script tag does in an index.html file
Script tags allow the user to link external JavaScript files.
*/
/*Question 9: 4 points */
/* Explain the importance of JavaScript in web development 
JavaScript is important in web design because it allows us to add functionality to a website.
*/
...
Please type the answer below this comment */
let name = document.getElementsByClassName("no");
...
let name = document.querySelectorAll("btn")
